...
const img_url = "https://image.tmdb.org/t/p/w185"; // You can change "w185" to your preferred size
...
const requests = {
  ...
  fetchScienceFiction: `${base_url}/discover/movie?${api}&with_genres=878`,
};
...
fetch(requests.fetchNetflixOrignals)
  ...
  .then((data) => {
    ...
    title.innerText = "NETFLIX ORIGINAL";
...
fetch(requests.fetchAnimationMovies)
  ...
  .then((data) => {
    ...
    const title = document.createElement("h2");
    title.className = "row__title";
    title.innerText = "Animated Movies";
    row.appendChild(title);
...
// documentry
fetch(requests.fetchScienceFiction)
  .then((res) => res.json())
